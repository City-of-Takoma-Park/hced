...
plot_pov_sex <- plot_ly(poverty_sex,
        ...
        y = ~ pct_sex_pov,
        name = ~ sex,
        text = ~ glue("Significant differences: {signif_check}"),
        color = ~ sex) %>%
...
5) [Poverty by race and sex]

6) [Poverty by race and age]

7) [Poverty by sex and age]
