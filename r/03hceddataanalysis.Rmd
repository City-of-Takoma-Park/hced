...
data_binder <- function(file_root){
  # browser()
  acsprocess::data_binder(file_root = file_root, dir_root = "./data/output_data/acs5_2020/tpspec/")
}
...
Please send any questions, comments, or feedback to Senior Policy and Data Analyst Dan Powers at danielp@takomaparkmd.gov.
...
renter_costs <- read_rds("./data/output_data/acs5_2020/tpspec//household_income_rentercosts_processed_tp.rds")

owner_costs <- read_rds("./data/output_data/acs5_2020/tpspec//household_income_ownercosts_processed_tp.rds")
